...
export const avatarItems: SpaceShopItem[] = [
  {
    ...
    name: 'Blue Astronaut',
    description: 'Classic blue space suit',
    category: 'avatar',
    price: 200,
    rarity: 'common',
    icon: '👨‍🚀',
  ...
  {
    id: 'avatar-astronaut-red',
    name: 'Red Astronaut',
    description: 'Bold red space suit',
    category: 'avatar',
    price: 200,
    rarity: 'common',
    icon: '🧑‍🚀',
  ...
  {
    id: 'avatar-astronaut-gold',
    name: 'Gold Astronaut',
    description: 'Prestigious golden space suit',
    category: 'avatar',
    price: 500,
    rarity: 'rare',
    icon: '👩‍🚀',
  ...
  },
  {
    ...
    name: 'Alien Explorer',
    description: 'Friendly extraterrestrial scholar',
    category: 'avatar',
    price: 600,
    rarity: 'epic',
    icon: '👽',
  ...
  },
  {
    ...
    name: 'Phoenix Nebula',
    description: 'Born from cosmic fire',
    category: 'avatar',
    price: 2000,
    rarity: 'legendary',
    icon: '🦅',
...
export const spaceshipItems: SpaceShopItem[] = [
  ...
  },
  {
    ...
    name: 'Star Cruiser',
    description: 'Reliable mid-range explorer',
    category: 'spaceship',
    price: 300,
    rarity: 'common',
    icon: '🛸',
  ...
  {
    id: 'ship-nebula-glider',
    name: 'Nebula Glider',
    description: 'Sleek and swift through cosmic clouds',
    category: 'spaceship',
    price: 500,
    rarity: 'rare',
    icon: '✈️',
  ...
  {
    id: 'ship-asteroid-hopper',
    name: 'Asteroid Hopper',
    description: 'Agile craft for navigating rocky fields',
    category: 'spaceship',
    price: 700,
    rarity: 'rare',
    icon: '🛩️',
  ...
  },
  {
    id: 'ship-void-wraith',
    name: 'Void Wraith',
    description: 'Phases through dimensions',
    category: 'spaceship',
    price: 3000,
    rarity: 'legendary',
    icon: '👻',
